...
class UserSerializer(serializers.ModelSerializer):   # user uchun [serializer]() klasi
...
class LoginSerializer(serializers.Serializer):         # user login uchun [serializer]() klasi
